...
func NewConfig() *Config {
	return &Config{
		...
		UserDBPass:    "postgres",       //,os.Getenv("AUTHENTICATION_DB_PASS"),
		...
		SigningJwtKey: "123456",         //os.Getenv("SIGNING_JWT_KEY"),
		RBACConfig:    "../../infrastructure/middleware/rbac_model.conf",
		RBACPolicy:    "../../infrastructure/middleware/rbac_policy.csv",
	}
}
