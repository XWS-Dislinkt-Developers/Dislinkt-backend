...
var users = []*domain.User{
	// USERS
	{
		...
		UserId:           1,
		Skills:           "C++, Blockchain, Cloud computing, Analytical reasoning, Artificial intelligence",
		Interests:        "Korean culture, Cooking, Movies",
		Work:             "Technology advisor of Google, C++ back-end freelancer",
		Education:        "Faculty of Technical Sciences (FTN)",
	},
	{
		Name:             "Joka",
		Username:         "Joka",
		...
		IsPrivateProfile: false,
		UserId:           2,
		Skills:           "Cloud computing, Vue.js, Node.js",
		Interests:        "Running, Swimming, Fishing",
		Work:             "Front-end developer at Levi9",
		Education:        "Faculty of Technical Sciences (FTN)",
	},
	{
		Name:             "Marko",
		...
		IsPrivateProfile: false,
		UserId:           3,
		Skills:           "Oracle, Postgres, MongoDB, Neo4j, Blockchain, Artificial intelligence",
		Education:        "Faculty of Technical Sciences (FTN)",
	},
	{
		Name:             "Zeksa",
		...
		IsPrivateProfile: false,
		UserId:           4,
		Skills:           "Python, OpenCV, Artificial intelligence",
		Interests:        "Karate",
		Work:             "Python developer freelancer",
		Education:        "Faculty of Technical Sciences (FTN)",
	},
	{
		Name:             "Sanja",
		...
		IsPrivateProfile: false,
		UserId:           5,
		Skills:           "Java, Spring Boot, Postgres, Photoshop",
		Interests:        "Drawing, Photoshop",
		Education:        "Faculty of Technical Sciences (FTN)",
	}, {
		Name:             "Tanja",
		Username:         "Tanja",
		...
		Interests:        "Education, Teamwork",
		Work:             "Part-time babysitter",
		Education:        "Faculty of Technical Sciences (FTN)",
	},
	{
		Name:             "Lale",
		...
		IsPrivateProfile: false,
		UserId:           7,
		Skills:           "Golang, Angular, Docker",
		Interests:        "Movies, Filmmaking",
		Education:        "Faculty of Technical Sciences (FTN)",
	},
	{
		Name:             "Nena",
		...
		UserId:           8,
		Skills:           "Spring Boot",
		Interests:        "Travelling, Montenegro",
		Work:             "Spring Boot developer at Levi9",
		Education:        "Faculty of Technical Sciences (FTN)",
	},
	{
		ID:            9,
